...
### 💖 Sobre mí...
* 🐾 **Cat lover:** Fiel creyente de que el código corre mejor con un gato roncando al lado, necesito a alguien que supervise mi trabajo 24/7.
* 🍫 **Combustible favorito:** Los chocolates y una taza de café son indispensables para mis noches de *coding*.
* 💐 **Detalles:** Amante de las flores y de los diseños de interfaces limpios y hermosos.
* 🔧 **Tech Medic:** Me relaja desarmar, limpiar y reparar computadoras para devolverlas a la vida.
...
* **Lenguajes de Programación:** 
  * `C++` 🟦
  * `Java` ☕
  * `Python` 🐍 *(Aprendiendo y mejorando cada día)*
* **SGBD:** `MySQL` 🐬 | `PostgreSQL` 🐘
* **Soporte & Hardware:** Mantenimiento preventivo/correctivo, diagnóstico de componentes y diseño de circuitos.
